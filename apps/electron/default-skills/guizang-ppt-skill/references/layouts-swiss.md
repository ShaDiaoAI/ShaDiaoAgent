...
`上游仓库 op7418/guizang-ppt-skill 的 ppt/index.html`
...
1. 同时打开三份页面:原始参考 PPT、当前 `template-swiss.html` 或生成页、正在修改的测试 PPT。原始参考路径是 `上游仓库 op7418/guizang-ppt-skill 的 ppt/index.html`。
