 ...
 *
 * 数据来源：~/.shadiao-agent/agent-sessions/{id}.jsonl 里最后一条带 usage 的消息。
 * 优先级：
...
import { calculateContextUsageRatio, inferAgentSdkContextWindow, inferContextWindow } from '@shadiao/shared'
import type { SDKAssistantMessage, SDKResultMessage } from '@shadiao/shared'
