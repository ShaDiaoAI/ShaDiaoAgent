 ...
 * 获取配置目录名称
 *
 * 开发模式下返回 '.shadiao-agent-dev'，正式版本返回 '.shadiao-agent'。
 *
 * 检测优先级：
 * 1. SHADIAO_DEV=1 或 PROMA_DEV=1 环境变量（显式覆盖；PROMA_DEV 为向后兼容）
...
export function getConfigDirName(): string {
  if (_configDirName === undefined) {
    // SHADIAO_DEV 优先，PROMA_DEV 向后兼容
    if (process.env.SHADIAO_DEV === '1' || process.env.PROMA_DEV === '1') {
      _configDirName = DEV_DIR
    } else {
      try {
        const { app } = require('electron')
        _configDirName = app.isPackaged ? PROD_DIR : DEV_DIR
      } catch {
        _configDirName = PROD_DIR
      }
    }
 ...
 * 获取渠道配置文件路径
 *
 * @returns ~/.shadiao-agent/channels.json
 */
 ...
 * 获取对话索引文件路径
 *
 * @returns ~/.shadiao-agent/conversations.json
 */
 ...
 * 如果目录不存在则自动创建。
 *
 * @returns ~/.shadiao-agent/conversations/
 */
 ...
 *
 * @param id 对话 ID
 * @returns ~/.shadiao-agent/conversations/{id}.jsonl
 */
 ...
 * 如果目录不存在则自动创建。
 *
 * @returns ~/.shadiao-agent/attachments/
 */
 ...
 * @returns ~/.shadiao-agent/attachments/{conversationId}/
 */
 ...
 * @returns 完整路径 ~/.shadiao-agent/attachments/{conversationId}/{uuid}.ext
 */
 ...
 * 获取应用设置文件路径
 *
 * @returns ~/.shadiao-agent/settings.json
 */
 ...
 * 获取系统默认 App 探测缓存路径
 *
 * @returns ~/.shadiao-agent/default-apps.json
 */
 ...
 * 获取用户档案文件路径
 *
 * @returns ~/.shadiao-agent/user-profile.json
 */
 ...
 * 获取代理配置文件路径
 *
 * @returns ~/.shadiao-agent/proxy-settings.json
 */
 ...
 * 获取系统提示词配置文件路径
 *
 * @returns ~/.shadiao-agent/system-prompts.json
 */
 ...
 * 获取 Chat 工具配置文件路径
 *
 * @returns ~/.shadiao-agent/chat-tools.json
 */
 ...
 * 获取 Agent 会话索引文件路径
 *
 * @returns ~/.shadiao-agent/agent-sessions.json
 */
 ...
 * 如果目录不存在则自动创建。
 *
 * @returns ~/.shadiao-agent/agent-sessions/
 */
 ...
 *
 * @param id 会话 ID
 * @returns ~/.shadiao-agent/agent-sessions/{id}.jsonl
 */
 ...
 * 获取 Agent 工作区索引文件路径
 *
 * @returns ~/.shadiao-agent/agent-workspaces.json
 */
 ...
 * 如果目录不存在则自动创建。
 *
 * @returns ~/.shadiao-agent/agent-workspaces/
 */
 ...
 *
 * @param slug 工作区 slug
 * @returns ~/.shadiao-agent/agent-workspaces/{slug}/
 */
 ...
 *
 * @param slug 工作区 slug
 * @returns ~/.shadiao-agent/agent-workspaces/{slug}/mcp.json
 */
 ...
 *
 * @param slug 工作区 slug
 * @returns ~/.shadiao-agent/agent-workspaces/{slug}/skills/
 */
 ...
 *
 * @param slug 工作区 slug
 * @returns ~/.shadiao-agent/agent-workspaces/{slug}/workspace-files/
 */
 ...
 * @returns ~/.shadiao-agent/agent-workspaces/{slug}/{sessionId}/
 */
 ...
 *
 * @param slug 工作区 slug
 * @returns ~/.shadiao-agent/agent-workspaces/{slug}/skills-inactive/
 */
 ...
 *
 * @returns ~/.shadiao-agent/default-skills/
 */
...
/**
 * 获取打包进 App 的 shadiao-agent CLI 二进制路径。
 *
...
export function getBundledCliPath(): string | undefined {
  ...
  const binName = process.platform === 'win32' ? 'shadiao-agent.exe' : 'shadiao-agent'
...
/**
 * 从 app bundle 同步默认 Skills 到 ~/.shadiao-agent/default-skills/
 *
 ...
 * 获取微信配置文件路径
 *
 * @returns ~/.shadiao-agent/wechat.json
 */
 ...
 * 获取微信长轮询同步游标路径
 *
 * @returns ~/.shadiao-agent/wechat-sync.json
 */
 ...
 * 获取微信聊天绑定持久化路径
 *
 * @returns ~/.shadiao-agent/wechat-bindings.json
 */
 ...
 * 获取钉钉配置文件路径
 *
 * @returns ~/.shadiao-agent/dingtalk.json
 */
 ...
 *
 * @returns ~/.shadiao-agent/dingtalk-bindings-{botId}.json
 */
 ...
 * 获取飞书配置文件路径
 *
 * @returns ~/.shadiao-agent/feishu.json
 */
 ...
 * 获取飞书聊天绑定持久化路径
 *
 * @returns ~/.shadiao-agent/feishu-bindings.json
 */
 ...
 *
 * @returns ~/.shadiao-agent/feishu-bindings-{botId}.json
 */
 ...
 *
 * @returns ~/.shadiao-agent/feishu-metadata-{botId}.json
 */
 ...
 * 而不是用户的 ~/.claude.json，实现 ShaDiaoAgent 与 Claude Code CLI 的配置隔离。
 *
 * 如果目录不存在则自动创建。
 *
 * @returns ~/.shadiao-agent/sdk-config/
 */
 ...
 * 获取 Scratch Pad 文件路径
 *
 * @returns ~/.shadiao-agent/scratch-pad.md
 */
 ...
 *
 * @returns ~/.shadiao-agent/automations.json
 */
