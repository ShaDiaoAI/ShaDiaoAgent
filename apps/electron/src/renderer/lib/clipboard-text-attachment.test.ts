...
describe('长文本粘贴附件', () => {
  ...
  test('Given 草稿文件已经落盘 When 创建待发送附件 Then sourcePath 成为发送时的真实数据源', () => {
    ...
    const pending = createClipboardPendingFile(draft, '/tmp/shadiao-preview/clipboard-20260528-123456.txt', 'pending-1')

    expect(pending).toMatchObject({
      id: 'pending-1',
      filename: 'clipboard-20260528-123456.txt',
      mediaType: 'text/plain',
      sourcePath: '/tmp/shadiao-preview/clipboard-20260528-123456.txt',
