  ...
  return (
    <div className="rounded-xl bg-foreground/[0.035] p-4 shadow-inner">
      <div className="flex flex-col gap-3">
        <div>
          <div className="text-[13px] font-semibold text-foreground">推荐：让沙雕智能体创建</div>
          <div className="mt-1 text-xs leading-relaxed text-muted-foreground">
            在左侧会话里说清目标，并明确表示要求创建定时任务，沙雕智能体会生成任务描述，并补全周期、工作区和模型等配置，手动编辑更适合微调任务描述。
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-1 text-xs leading-relaxed text-muted-foreground">
            例：检查沙雕智能体仓库新增 issue，主动回复问答类问题，不清楚的部分整理到工作区目录下的 .context/issue-faq.md 文档；真正的 Bug 或请求罗列后发给我，不要记录任何重复的信息。
          </div>
        </div>
      </div>
    </div>
