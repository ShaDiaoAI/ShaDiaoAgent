        ...
        <div className="space-y-4 p-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="text-xs text-muted-foreground list-disc list-inside space-y-1">
              ...
              <li>沙雕智能体 已切换到 <span className="font-medium text-foreground">Agent 模式</span>（此提示词只能在 Agent 中执行）</li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground pt-1">
              ⚠️ 提示词执行完成后需要 <span className="font-medium text-foreground">完全退出并重启 沙雕智能体</span>，MCP 与 Hooks 才会生效
            </p>
          </div>
