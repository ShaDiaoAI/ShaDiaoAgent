/**
 * BuiltinMcpDetailSheet — 沙雕智能体 内置 MCP 托管详情
 */
...
import type { BuiltinMcpServerSummary } from '@shadiao/shared'
...
function getConfigInfo(server: BuiltinMcpServerSummary): BuiltinMcpConfigInfo {
  ...
  if (server.id === 'automation') {
    return {
      source: '沙雕智能体 本地自动任务',
      description: '自动任务 MCP 直接使用 沙雕智能体 本地任务服务，无需填写额外凭据。',
    }
  }
  return {
    source: '沙雕智能体 运行时',
    description: '该内置 MCP 由 沙雕智能体 运行时托管。',
  }
}
