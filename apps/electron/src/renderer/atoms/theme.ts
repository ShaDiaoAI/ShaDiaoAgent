 ...
 * - themeModeAtom: 用户选择的主题模式，持久化到 ~/.shadiao-agent/settings.json
...
const THEME_STYLE_CACHE_KEY = 'shadiao-theme-style'
const INTERFACE_VARIANT_CACHE_KEY = 'shadiao-interface-variant'
